...
{
  if (!$con->query("insert into useraccounts (name,Aadhar,accountNum,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[Aadhar]','$_POST[accountNum]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <td><input type="" name="accountNum" readonly value="<?php echo time() ?>" class="form-control input-sm" required></td>
          <th>Account Type</th>
          <td>
